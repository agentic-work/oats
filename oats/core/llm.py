...
class OpenAICompatibleClient:
    ...
    - vLLM
    - LocalAI
    - Your custom endpoints (e.g., chat-dev.agenticwork.io)
    """
...
class AgenticWorkAPIClient:
    """
    Client for AgenticWork's API (chat-dev.agenticwork.io).

    Wraps the platform's chat API for use with Synth.
    """

    def __init__(
        self,
        base_url: str = "https://chat-dev.agenticwork.io",
        api_key: str | None = None,
        model: str = "claude-sonnet-4-20250514",
        max_tokens: int = 4096,
    ) -> None:
