...
class CapabilityAuth(BaseModel):
    ...
    description: str = ""
    header_name: str | None = None  # For api_key type: custom header name
    header_prefix: str | None = None  # For bearer type: custom prefix (default "Bearer")
...
class Capability(BaseModel):
    ...
    rate_limit: str | int | None = None  # e.g., "100/hour", "10/minute", or int (requests per minute)
    ...
    sdk_hints: str | None = None    # Free-text hints for the LLM about API style, pagination, etc.
